...
import { buildPlantProtectionList } from './build-plant-protection-list'
...
async function buildWildlifeProtectionList() {
  console.log('拉取维基百科动物名录…')
...
async function main() {
  await buildWildlifeProtectionList()
  await buildPlantProtectionList()
}
